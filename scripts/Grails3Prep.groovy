...
target(migrate: "Preps a Grails 2.X app or plugin to be Grails 3") {
    ...
    ant.move(todir:"$baseDirPath/src/main/groovy") {
        fileset(dir:"$baseDirPath/src/groovy")
    }
    ant.move(todir:"$baseDirPath/src/main/groovy") {
        fileset(dir:"$baseDirPath/src/java")
    }
    ant.move(todir:"$baseDirPath/src/test/groovy") {
        fileset(dir:"$baseDirPath/test/unit")
    }
    ant.move(todir:"$baseDirPath/src/integration-test/groovy") {
        fileset(dir:"$baseDirPath/test/integration")
    }

    //ant.delete(dir:"$stagingDir/src/groovy",failonerror:false)
